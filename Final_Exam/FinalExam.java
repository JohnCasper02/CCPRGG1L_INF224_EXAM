    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 8 && columns == 8 || rows == 7 && columns == 8 || rows == 6 && columns == 8 ||

                rows == 5 && columns == 8 || rows == 4 && columns == 8 || rows == 3 && columns == 8 || rows == 2 && columns == 8){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 1 && columns == 1 || rows == 2 && columns == 2 || rows == 3 && columns == 3 || rows == 4 && columns == 4 || rows == 5 && columns == 5 || rows == 6 && columns == 6 || rows == 7 && columns == 7 || rows == 8 && columns == 8 || rows == 9 && columns == 9){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 13 && columns == 2 || rows == 13 && columns == 3 || rows == 13 && columns == 4 ||

                rows == 13 && columns == 5 || rows == 13 && columns == 6 || rows == 13 && columns == 7 || rows == 13 && columns == 8){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (columns == 1 && rows == 8 || columns == 1 && rows == 9 || columns == 1 && rows == 10 ||

                columns == 1 && rows == 11 || columns== 1 && rows == 12 || columns == 1 && rows == 13 || columns == 1 && rows == 14){
        ...
        // CHILLTOP - (10 points)
        System.out.println(" ");
        System.out.println("5. CHILLTOP ");for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 10 && columns == 7 || rows == 9 && columns == 8|| rows == 8 && columns == 9 ||

                rows == 7 && columns == 10 || rows == 6 && columns == 11 || rows == 5 && columns == 12 || rows == 4 && columns == 13 || rows == 3 && columns == 14){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 10 && columns == 5 || rows == 9 && columns == 4 || rows == 8 && columns == 3 ||

                rows == 7 && columns == 2 || rows == 6 && columns == 1 || rows == 5 && columns == 0){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 12 && columns == 14 || rows == 12 && columns == 13 || rows == 12 && columns == 12 ||

                rows == 12 && columns == 11 || rows == 12 && columns == 10 || rows == 12 && columns == 9 || rows == 12 && columns == 8 || rows == 12 && columns == 7){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 0 && columns == 9 || rows == 1 && columns == 8 || rows == 2 && columns == 7 ||

                rows == 3 && columns == 6 || rows == 4 && columns == 5 || rows == 5 && columns == 4){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 6 && columns == 0 || rows == 7 && columns == 1 || rows == 8 && columns == 2 ||

                rows == 9 && columns == 3 || rows == 10 && columns == 4){
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int columns = 0; columns  <15; columns++){
                ...
                if (rows == 4 && columns == 14 || rows == 5 && columns == 14 || rows == 6 && columns == 14 ||

                rows == 7 && columns == 14 || rows == 8 && columns == 14 || rows == 9 && columns == 14 || rows == 10 && columns == 14 || rows == 11 && columns == 14 || rows == 12 && columns == 14){
